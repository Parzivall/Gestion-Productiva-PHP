...
CREATE TABLE `InventarioFisico` (
  ...
  `Codigo_Existencia` int(100) NOT NULL--aca lo modifique--
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


INSERT INTO `InventarioFisico` (`Id`,`TipoExistencia_Id`,`UnidadMedida_Id`,`Unidad_Id`,`Periodo`,`Descripcion_Existencia`,`Codigo_Existencia`) VALUES
(0,0,0,26,'12-31','Prueba1','0');
...
CREATE TABLE `InventarioFisico_Detalle` (
  ...
  `Edad` tinyint(4) NOT NULL,--aqui lo modifique conun varchar--
  `Observaciones` varchar(100) NOT NULL,
...
INSERT INTO `InventarioFisico_Detalle` (`Id`,`Cantidad`,`Estado`,`Edad`,`Observaciones`,`InventarioFisico_Id`,`Material_Insumo_Id`) VALUES
(0,1,1,2,'ninguna',1,0);
...
INSERT INTO `Material_Insumo` (`Id`,`Descripcion`,`Marca`) VALUES
(0,'cm','Toyota');
-- --------------------------------------------------------
