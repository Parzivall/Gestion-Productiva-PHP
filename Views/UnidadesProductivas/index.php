                    ...
                    <div class="content">
                        ...
                        <nav><ul class="pagination">
                            <?php if(!empty($totalPages)):for($i=1; $i<=$totalPages; $i++):  
                                        if($i == 1):?>
                                        <li class='active'  id="<?php echo $i;?>"><a href='<?php echo BASE_URL;?>UnidadesProductivas/Pagination/Page/<?php echo $i;?>'><?php echo $i;?></a></li> 
                                        <?php else:?>
                                        <li id="<?php echo $i;?>"><a href='<?php echo BASE_URL;?>UnidadesProductivas/Pagination/Page/<?php echo $i;?>'><?php echo $i;?></a></li>
                                    <?php endif;?>          
                            <?php endfor;endif;?>
                        </ul></nav>
                    </div>
...
$(document).ready(function(){
    $('.pagination').pagination({
            ...
            onPageClick : function(pageNumber) {
                ...
                $("#target-content").load(base + "UnidadesProductivas/Pagination/Page/" + pageNumber);
            }
        });
    });
</script>